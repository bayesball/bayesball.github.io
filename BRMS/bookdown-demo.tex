...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{olympic_butterfly }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{year_64 =}\NormalTok{ Year }\OperatorTok{-}\StringTok{ }\DecValTok{1964}\NormalTok{,}
         \DataTypeTok{gender =} \KeywordTok{ifelse}\NormalTok{(Gender }\OperatorTok{==}\StringTok{ "Women"}\NormalTok{,}
                         \DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{filter}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(Time) }\OperatorTok{==}\StringTok{ }\OtherTok{FALSE}\NormalTok{) ->}
\StringTok{  }\NormalTok{olympic_butterfly2}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{mean_time_1972 =}
\NormalTok{           b_Intercept }\OperatorTok{+}\StringTok{ }\DecValTok{8} \OperatorTok{*}\StringTok{ }\NormalTok{b_year_}\DecValTok{64}\NormalTok{) ->}
\StringTok{  }\NormalTok{post}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{\}}
\NormalTok{post }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{p_550_3.5 =} \KeywordTok{invlogit}\NormalTok{(b_Intercept }\OperatorTok{+}
\StringTok{                }\NormalTok{b_GRE }\OperatorTok{*}\StringTok{ }\DecValTok{550} \OperatorTok{+}\StringTok{ }\NormalTok{b_GPA }\OperatorTok{*}\StringTok{ }\FloatTok{3.5}\NormalTok{),}
         \DataTypeTok{p_550_4.0 =} \KeywordTok{invlogit}\NormalTok{(b_Intercept }\OperatorTok{+}
\StringTok{                }\NormalTok{b_GRE }\OperatorTok{*}\StringTok{ }\DecValTok{550} \OperatorTok{+}\StringTok{ }\NormalTok{b_GPA }\OperatorTok{*}\StringTok{ }\FloatTok{4.0}\NormalTok{)) ->}
\StringTok{  }\NormalTok{post}
\end{Highlighting}
\end{Shaded}
